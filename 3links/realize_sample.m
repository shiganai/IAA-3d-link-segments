...
func_RJT2 = @(t) [0,0,0];
func_RJT3 = @(t) [0,0,0];
func_RJT = @(t) [func_RJT1(t), func_RJT2(t), func_RJT3(t)];
...
xArray = [p_seg1_corners(:,:,1), NaN_array, p_seg2_corners(:,:,1), NaN_array, p_seg3_corners(:,:,1)];
yArray = [p_seg1_corners(:,:,2), NaN_array, p_seg2_corners(:,:,2), NaN_array, p_seg3_corners(:,:,2)];
zArray = [p_seg1_corners(:,:,3), NaN_array, p_seg2_corners(:,:,3), NaN_array, p_seg3_corners(:,:,3)];

addpath("..\")
anime_fig = SimplestAnime_exported(time, xArray, yArray, zArray);

range = [ -1.1, 1.1 ] * (l1 + l2 + l3);
