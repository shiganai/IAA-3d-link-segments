...
syms lg1 lg2 lg3 lg4 real
syms width1 width2 width3 width4 real
...
syms theta4_pre_(t) [1 3]
syms theta4_ omega4_ alpha4_ [1 3] real
theta4_pre_ = formula( theta4_pre_ );
...
syms_Replaced = [
    ...
    theta4_pre_ diff(theta4_pre_, t) diff(theta4_pre_, t, t), ...
...
R4 = find_z_rot_mat( theta4_pre_(3) ) ...
    * find_y_rot_mat( theta4_pre_(2) ) ...
    * find_x_rot_mat( theta4_pre_(1) ) ...
    ;
...
%% move segment4
seg4_bottom = seg4_bottom + seg3_bottom;
seg4_com = seg4_com + seg3_bottom;
seg4_corners = seg4_corners + repmat( seg3_bottom, 1, 1, 4 );
...
seg4_bottom = formula( seg4_bottom );
seg4_com = formula( seg4_com );
seg4_corners = formula( seg4_corners );
