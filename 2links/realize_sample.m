...
func_RJT1 = @(t) [0,0,0];
func_RJT2 = @(t) [0,0,0];
func_RJT = @(t) [func_RJT1(t), func_RJT2(t)];
...
q0 = [th1_0, th2_0, omega1_0, omega2_0]';
...
xArray = [p_seg1_corners(:,:,1), NaN_array, p_seg2_corners(:,:,1)];
yArray = [p_seg1_corners(:,:,2), NaN_array, p_seg2_corners(:,:,2)];
zArray = [p_seg1_corners(:,:,3), NaN_array, p_seg2_corners(:,:,3)];
